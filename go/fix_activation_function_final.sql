-- إصلاح نهائي لخطأ PostgrestException: مرجع العمود "code" غامض
-- حل مشكلة تضارب أسماء الأعمدة في دالة generate_activation_code_enhanced

-- الخطوة 1: حذف الدالة الموجودة مع تحديد نوع المعاملات بدقة
DROP FUNCTION IF EXISTS generate_activation_code_enhanced(uuid, integer);

-- الخطوة 2: إنشاء الدالة المصححة مع نوع إرجاع جديد

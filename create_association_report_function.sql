...
-- This function provides comprehensive report data for associations
...
DO $$
BEGIN
  RAISE NOTICE 'Function get_association_report_data has been created successfully!';
  RAISE NOTICE 'This function provides comprehensive report data for associations including:';
  RAISE NOTICE '- Total and completed donations count';
  RAISE NOTICE '- Active volunteers count';
  RAISE NOTICE '- Food type distribution';
  RAISE NOTICE '- Monthly donations trend';
  RAISE NOTICE '- Top donors and volunteers';
END $$;